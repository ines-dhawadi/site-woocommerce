...
function ultra_theme_settings() {
	...
	$settings->add_field( 'header', 'logo_with_title', 'checkbox', esc_html__( 'Display Site Title and Logo', 'ultra' ), array(
		'description' => esc_html__( 'Only applicable if a logo image has been set.', 'ultra' ),
	) );
